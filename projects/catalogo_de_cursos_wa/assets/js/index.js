...
function Controle(elemento) {
	var self = this;
	var trilhas = [];
	var tagTilhla = elemento.querySelectorAll(".track");
...
function Trilha(elemento) {
	...
	var navegacaoCriada;
	var exibirDetalhes;
	var tagDetalhes = elemento.querySelector(".track-detail");
	var botaoDestalhes = elemento.querySelector(".bt-track-detail");
	...
	function criaNavegacao() {
		$(elemento).find(".track-slider").flexisel({
			clone:false,
	        visibleItems: 4,
